            ...
            <div className="flex flex-col gap-3">
                <div className="flex items-center justify-center">
                    ...
                    >
                        ...
                        <span>{kakaoLoading ? "로그인 중..." : "Continue with Kakao"}</span>
                    </Link>
                </div>
                <div className="flex items-center justify-center">
                    <Link
                        ...
                        className={`primary-btn flex items-center justify-center gap-3 bg-[#24292F] text-white hover:bg-[#1B1F23] ${githubLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        <svg
                            className="size-6"
                            viewBox="0 0 24 24"
                        ...
                        <span>{githubLoading ? "로그인 중..." : "Continue with GitHub"}</span>
                    </Link>
                </div>
                {/* <div className="flex items-center justify-center">
